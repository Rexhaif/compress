...
const SERIAL_SKIP_INSERT_DEPTH_MAX: u32 = 22;
const SERIAL_SKIP_INSERT_NICE_MAX: u32 = 44;
const THREADED_SKIP_INSERT_DEPTH_MAX: u32 = 17;
const THREADED_SKIP_INSERT_NICE_MAX: u32 = 34;
...
mod tests {
    ...
    fn parallel_default_block_size_exposes_more_work() {
        ...
        options.threads = 4;
        assert_eq!(default_block_size(&options), 32 * 1024 * 1024);
    }
